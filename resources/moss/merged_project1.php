...
class HomeController extends Controller
{
    ...
    public function saveReview(Request $request){
        ...
        $review0 = new Review();
        $review0->review0 = $request->review0;
        $review0->rating = $request->rating;
        $review0->user_id = Auth::user()->id;
        $review0->book_id = $request->book_id;
        $review0->save();
        ...
        //         'status' => true
        // ]);
        return redirect()->route('book.detail',$request->book_id)->with('success','Review submitted successfully.');
    }
                            ...
                            @foreach ($relatedBooks as $relatedBook)
                                <div class="col-md-4 col-lg-4 mb-4">
                                    <div class="card border-0 shadow-lg">
                                        ...
                                        <div class="card-body">
                                            <h3 class="h4 heading"><a href="{{route("book.detail",$book->id)}}">{{$relatedBook->title}}</a></h3>
                ...
                <form action="{{route('book.saveReview')}}" id="bookReviewForm" name="bookReviewForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <textarea name="review0" id="review0" class="form-control" cols="5" rows="5" placeholder="Review"></textarea>
                            <p class="invalid-feedback" id="review0-error"></p>
                        </div>
                        <div class="mb-3">
            ...
            $.ajax({
                ...
                success: function(respone){
                    if (respone.status == false) {
                        ...
                        if(errors.review0){
                            $("#review0").addClass('is-invalid');
                            $("#review0-error").html(errors.review0);
                        } else {
                            $("#review0").removeClass('is-invalid');
                            $("#review0-error").html('');
                        }
                    } else {
                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body pb-0">
                            <form action="{{ route('account.reviews.updateReview',$review->id) }}" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Review</label>
                                    <textarea placeholder="Review" class="form-control @error('review') is-invalid @enderror" name="review0" id="review0" >{{old('review0',$review->review0)}}</textarea>
                                    @error('review')
                                        <p class="invalid-feedback">{{ $message }}</p>
                                    @enderror
                                </div>
